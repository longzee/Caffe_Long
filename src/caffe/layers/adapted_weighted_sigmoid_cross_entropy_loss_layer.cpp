...
#include "caffe/layers/adapted_weighted_sigmoid_cross_entropy_loss_layer.hpp"
#include "caffe/util/math_functions.hpp"

namespace caffe {

template <typename Dtype>
void AdaptedWeightedSigmoidCrossEntropyLossLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void AdaptedWeightedSigmoidCrossEntropyLossLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void AdaptedWeightedSigmoidCrossEntropyLossLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void AdaptedWeightedSigmoidCrossEntropyLossLayer<Dtype>::Backward_cpu(
...
REGISTER_LAYER_CLASS(AdaptedWeightedSigmoidCrossEntropyLoss);
